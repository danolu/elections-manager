<div class="max-w-3xl mx-auto bg-white rounded-lg shadow p-6">
    ...
    <form wire:submit.prevent="save" enctype="multipart/form-data">
        ...
        <div class="flex items-center gap-2">
            <button type="submit" class="bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700">{{ $candidateId ? 'Update' : 'Save' }}</button>
            <a href="{{ route('candidates.index') }}" class="bg-gray-600 text-white px-4 py-2 rounded-md hover:bg-gray-700">Cancel</a>
        </div>
    </form>
</div>
